...
export const RegistryUI = ({
  ...
  return (
    <div className='relative w-full min-h-screen flex flex-col'>
      <div className='fixed top-0 left-0 w-full -mt-24 lg:-mt-0 h-[320px] md:h-screen bg-no-repeat bg-right-top md:bg-right md:bg-[url("/registry_banner_new.svg")] bg-[url("/registry_banner_mobile_new.svg")] z-0'></div>
