        ...
        <Table>
          <TableHeader className='bg-[#1A1A1C]'>
            <TableRow className='border-b border-[#313E52] hover:bg-transparent'>
              <TableHead className='text-zinc-400 font-medium py-4 px-6 w-12'>
                #
              </TableHead>
              <TableHead className='text-zinc-400 font-medium py-4 px-6 text-sm text-[#848485]'>
                USER
              </TableHead>
              <TableHead className='text-zinc-400 font-medium py-4 px-6 text-sm text-[#848485]'>
                SOCIALS
              ...
              <TableHead className='text-zinc-400 font-medium py-4 px-6 text-right text-sm text-[#848485]'>
                PINGS 7D
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody className='bg-[#1A1A1C]'>
            {Array.from({ length: 8 }).map((_, index) => (
              <TableRow key={index} className='hover:bg-[#252529] border-0'>
                ...
                <TableCell className='py-4 px-6 text-right border-0'>
        ...
        <TableBody className='bg-[#1A1A1C]'>
          {leaderboard.map((user) => (
            <TableRow key={user.id} className='hover:bg-[#252529] border-0'>
              <TableCell className='py-4 px-6 text-zinc-200 border-0'>
                {user.id}
              </TableCell>
              <TableCell className='py-4 px-6 text-zinc-200 border-0'>
                {user.username}
              ...
              <TableCell className='py-4 px-6 border-0'>
                <div className='flex items-center'>
                  ...
                  <span className='text-zinc-200'>
                    {user.payout} <span className='text-zinc-500'>$BITTE</span>
                  </span>
                </div>
              </TableCell>
              <TableCell className='py-4 px-6 border-0'>
              ...
              <TableCell className='py-4 px-6 text-right text-zinc-200 border-0'>
