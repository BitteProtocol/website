        ...
        <div
          className={cn(
            ...
            variant === 'floating' || variant === 'inset'
              ...
              : 'group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-r group-data-[side=right]:border-l border-[#18181A]',
            className
          )}
          {...props}
        >
          <div
            data-sidebar='sidebar'
            className='flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-[#18181A] group-data-[variant=floating]:shadow'
          >
            {children}
          </div>
        </div>
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      'mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-[#18181A] px-2.5 py-0.5',
      'group-data-[collapsible=icon]:hidden',
      className
    )}
    {...props}
