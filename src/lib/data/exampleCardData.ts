  ...
  cards: [
    {
      ...
      action: 'Deploy a Safe on Base',
      sub: '',
      bg: '/examples/chain_txn.svg',
      link: `/chat?agentid=near-safe-agent.vercel.app&prompt=Deploy a Safe on Base`,
      isSA: true,
      gradientLayer: false,
    },
    {
...

    {
      ...
      link: `/chat?agentid=near-cow-agent.vercel.app&prompt=Swap 5 USDC for VIRTUAL on Base`,
      isSA: true,
      gradientLayer: false,
    },
    {
